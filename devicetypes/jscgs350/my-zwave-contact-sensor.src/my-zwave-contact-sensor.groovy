...
metadata {
	definition (name: "My Z-Wave  Contact Sensor", namespace: "jscgs350", author: "SmartThings") {
...
//		fingerprint deviceId: "0x0701", inClusters: "0x5E,0x86,0x72,0x98", outClusters: "0x5A,0x82"
	...
	tiles {
		standardTile("contact", "device.contact", width: 2, height: 2) {
			state "ON GEN", label: '${name}', icon: "st.contact.contact.open", backgroundColor: "#ffa81e"
			state "ON CITY", label: '${name}', icon: "st.contact.contact.closed", backgroundColor: "#79b821"
		}
...
def sensorValueEvent(value) {
	if (value) {
		createEvent(name: "contact", value: "ON CITY", descriptionText: "$device.displayName is On City")
	} else {
		createEvent(name: "contact", value: "ON GEN", descriptionText: "$device.displayName is On Gen")
	}
}
